...
namespace MainContents.MonoBehaviourTest
{
    ...
    public class DokabenMonoBehaviourTest : MonoBehaviour
    {
        ...
        public class Dokaben
        {
            ...
            /// <param name="sharedMaterial">共通マテリアル</param>
            public Dokaben(GameObject basePrefab, Vector3 position, Material sharedMaterial)
            {
            ...
            public void Rotate(float time)
            {
                ...
                float sinTime = Mathf.Sin(time * Constants.MatrixTest.AnimationSpeed);
        ...
        void Start()
        {
            ...
            for (int i = 0; i < this._maxObjectNum; ++i)
            {
                ...
                this._dokabens[i] = new Dokaben(this._basePrefab, pos, this._sharedMaterial);
            }
        }
